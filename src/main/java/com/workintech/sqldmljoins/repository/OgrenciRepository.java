...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    //--Ali: 2, Mehmet: 3
    String QUESTION_7 = "SELECT ad, COUNT(ogrno) as count FROM ogrenci GROUP BY ad";
    @Query(value = QUESTION_7, nativeQuery = true)
    List<StudentNameCount> findStudentNameCount();


    String QUESTION_8 = "SELECT sinif, COUNT(ogrno) as count FROM ogrenci GROUP BY sinif";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();

    String QUESTION_9 = "SELECT o.ad, o.soyad, COUNT(i.islemno) as count FROM ogrenci o INNER JOIN islem i ON o.ogrno = i.ogrno GROUP BY o.ad, o.soyad";
